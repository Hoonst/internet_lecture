...
class Scheduler(object):
    ...
    def from_crawler(cls, crawler):
        ...
        logunser = settings.getbool(
            "LOG_UNSERIALIZABLE_REQUESTS", settings.getbool("SCHEDULER_DEBUG")
        )
        return cls(
            dupefilter,
    ...
    def _mq(self):
        ...
        return create_instance(
            self.pqclass, None, self.crawler, self._newmq, serialize=False
        )
    ...
    def _dq(self):
        ...
        q = create_instance(
            self.pqclass, None, self.crawler, self._newdq, state, serialize=True
        )
        if q:
            logger.info(
