...
class HTTP11DownloadHandler(object):
    ...
    def __init__(self, settings):
        ...
        try:
            ...
            self._contextFactory = create_instance(
                self._contextFactoryClass, settings=settings, crawler=None,
            )
            msg = """
...
class TunnelingTCP4ClientEndpoint(TCP4ClientEndpoint):
    ...
    def __init__(
        ...
        super(TunnelingTCP4ClientEndpoint, self).__init__(
    ...
    def connect(self, protocolFactory):
        ...
        connectDeferred = super(TunnelingTCP4ClientEndpoint, self).connect(
            protocolFactory
        )
...
class _ResponseReader(protocol.Protocol):
    def __init__(
        self, finished, txresponse, request, maxsize, warnsize, fail_on_dataloss
    ):
