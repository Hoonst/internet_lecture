...
class ClassicLogFormattingTests(unittest.TestCase):
    ...
    def test_formatLevel(self):
        ...
        self.assertEqual(
            formatEventAsClassicLogText(event), u"- [-\x23warn] XYZZY\n",
        )
    ...
    def test_formatFormat(self):
        ...
        self.assertEqual(
            formatEventAsClassicLogText(event), u"- [-\x23-] id:123\n",
        )
...
class EventAsTextTests(unittest.TestCase):
    ...
    def test_eventAsTextTimestampOnly(self):
        ...
        self.assertEqual(
            eventText, u"2013-09-24T11:40:47+0000 ABCD",
        )
