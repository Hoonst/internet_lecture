...
class HAProxyWrappingFactoryV1Tests(unittest.TestCase):
    ...
    def test_validIPv4HeaderResolves_getPeerHost(self):
        ...
        self.assertEqual(
            proto.wrappedProtocol.transport.getPeer().host, b"1.1.1.1",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            proto.wrappedProtocol.transport.getHost().host, b"2.2.2.2",
        )
        self.assertEqual(
    ...
    def test_validIPv6HeaderResolves_getPeerHost(self):
        ...
        self.assertEqual(proto.getPeer().port, 8080)
        self.assertEqual(
            proto.wrappedProtocol.transport.getPeer().host, b"::1",
        )
        self.assertEqual(
            proto.wrappedProtocol.transport.getPeer().port, 8080,
        )
        ...
        self.assertEqual(proto.getHost().port, 8888)
        self.assertEqual(
            proto.wrappedProtocol.transport.getHost().host, b"::2",
        )
        self.assertEqual(
            proto.wrappedProtocol.transport.getHost().port, 8888,
        )
...
class HAProxyWrappingFactoryV2Tests(unittest.TestCase):
    ...
    def test_validIPv4HeaderResolves_getPeerHost(self):
        ...
        self.assertEqual(proto.getPeer().port, 8080)
        self.assertEqual(
            proto.wrappedProtocol.transport.getPeer().host, b"127.0.0.1",
        )
        self.assertEqual(
            proto.wrappedProtocol.transport.getPeer().port, 8080,
        )
        ...
        self.assertEqual(proto.getHost().port, 8888)
        self.assertEqual(
            proto.wrappedProtocol.transport.getHost().host, b"127.0.0.1",
        )
        self.assertEqual(
            proto.wrappedProtocol.transport.getHost().port, 8888,
        )
