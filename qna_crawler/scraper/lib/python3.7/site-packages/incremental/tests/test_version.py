...
class VersionsTests(TestCase):
    ...
    def test_strWithDev(self):
        ...
        """
        self.assertEqual(
            str(Version("dummy", 1, 0, 0, dev=1)), "[dummy, version 1.0.0dev1]"
        )
    ...
    def test_getVersionStringWithDev(self):
        ...
        """
        self.assertEqual(
            getVersionString(Version("whatever", 8, 0, 0, dev=1)), "whatever 8.0.0dev1"
        )
    ...
    def test_baseWithDevAndRC(self):
        ...
        """
        self.assertEqual(
            Version("foo", 1, 0, 0, release_candidate=2, dev=8).base(), "1.0.0rc2dev8"
        )
