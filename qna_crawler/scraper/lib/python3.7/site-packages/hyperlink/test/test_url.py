...
class TestURL(HyperlinkTestCase):
    ...
    def test_idna(self):
        ...
        self.assertEquals(u2.to_iri().to_text(), "https://bücher.ch")
    ...
    def test_netloc_slashes(self):
        ...
        self.assertEquals(url.to_text(), "git+ftp://gitstub.biz/glyph/lefkowitz")

        url = URL.from_text("what+mailto:freerealestate@enotuniq.org")
        self.assertEquals(url.scheme, "what+mailto")
        self.assertEquals(url.to_text(), "what+mailto:freerealestate@enotuniq.org")
    ...
    def test_idna_corners(self):
        ...
        assert (
            URL.from_text("http://Example.com").to_uri().get_decoded_url().host
            == "example.com"
        )
